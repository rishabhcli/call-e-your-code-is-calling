...
7. **Supply-chain compromise:** exact pins, one frozen lockfile, image digests, warning-zero CI, dependency review, and clean-checkout verification reduce drift. SBOM/advisory gates remain Tier 10 work.
